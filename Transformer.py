...
class Transformer(Model):
    ...
    def __init__(self, num_encoder_layers:int, num_decoder_layers:int, d_model:int, num_heads:int, d_ff:int, output_vocab_size:int, maximum_position_encoding:int, dropout_rate:float= 0.1):
        super().__init__()
