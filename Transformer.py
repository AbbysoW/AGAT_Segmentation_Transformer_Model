...
class Transformer(Model):
    ...
    def call(self, x= None, y= None, training:bool=False, look_ahead_mask=None, padding_mask=None):
        ...
        if x != None:
            ...
            for layer in self.encoder:
                x = layer(x, training=training, mask=padding_mask)
        ...
        if y != None:
            ...
            for layer in self.decoder:
                y = layer(y, x, training=training, look_ahead_mask=look_ahead_mask, padding_mask=padding_mask)
        else:
            y = x
